...
import { CheckpointRef, MessageId, ProjectId, type ThreadId, TurnId } from "@peakcode/contracts";
import { resolveThreadWorkspaceCwd as resolveSharedThreadWorkspaceCwd } from "@peakcode/shared/threadEnvironment";
