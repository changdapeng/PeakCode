...
import { CheckpointRef } from "@peakcode/contracts";
        ...
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Peak Code",
              GIT_AUTHOR_EMAIL: "peakcode@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Peak Code",
              GIT_COMMITTER_EMAIL: "peakcode@users.noreply.github.com",
            };
