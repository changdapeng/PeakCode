...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@peakcode/shared/localImage";
 ...
 * writes images under for the current process env. When Peak Code wraps Codex
 * with the peakcode-browser overlay (production default), this is the overlay
 ...
 * overlay `<PEAKCODE_HOME>/codex-home-overlay/generated_images` so we serve
