...
const GROK_ACP_DEBUG_ENV = "PEAKCODE_GROK_ACP_DEBUG";
...
const GROK_PLAN_MODE_PROMPT_PREFIX = [
  "Peak Code Grok plan mode is active.",
...
// Grok may reuse ACP item ids across resumed history; Peak Code runtime ids must stay turn-local.
      ...
      withThreadLock(
        ...
        Effect.gen(function* () {
          ...
          const acp = yield* makeGrokAcpRuntime({
            ...
            clientInfo: { name: "Peak Code", version: "0.0.0" },
            ...acpRuntimeLoggers,
          }).pipe(
