    ...
    Effect.gen(function* () {
        ...
        if (!context.activeTurnToolCallIdleWatchdogStarted) {
          ...
          yield* Effect.gen(function* () {
            ...
            yield* completeOpenCodeTurn(context, {
              turnId,
              raw: {
                source: "peakcode.opencode.idle-after-tool-calls",
                event: raw,
              },
      ...
      const recoverOpenCodeTurnFromMessages = Effect.fn("recoverOpenCodeTurnFromMessages")(
        function* (
          ...
          return yield* recoverOpenCodeTurnFromAssistantMessage(context, {
            ...
            assistantEntry,
            raw: {
              source: "peakcode.opencode.prompt.recovery",
        ...
        yield* Effect.gen(function* () {
          ...
          Effect.flatMap(() =>
            Effect.gen(function* () {
              ...
              yield* completeOpenCodeTurn(context, {
                turnId: input.turnId,
                raw: { source: "peakcode.opencode.prompt.watchdog" },
                errorMessage: message,
              });
              updateProviderSession(
                context,
            ...
            Effect.gen(function* () {
              ...
              if (assistantEntry && isOpenCodeCompletedAssistantMessage(assistantEntry)) {
                yield* recoverOpenCodeTurnFromAssistantMessage(context, {
                  ...
                  assistantEntry,
                  raw: {
                    source: "peakcode.opencode.prompt.response",
                    message: assistantEntry,
                  },
                });
              }
      ...
      const handleSubscribedEvent = Effect.fn("handleSubscribedEvent")(function* (
        ...
        switch (event.type) {
          ...
          // agent loop. Mirror them into Peak Code's canonical transcript stream.
                ...
                const openCodeSessionId =
                  ...
                  (yield* runOpenCodeSdk("session.create", () => {
                    const sessionCreateInput = {
                      ...
                      title: `Peak Code ${input.threadId}`,
                    };
      ...
      const sendTurn: OpenCodeAdapterShape["sendTurn"] = Effect.fn("sendTurn")(function* (input) {
        ...
        // Always pin Peak Code's interaction mode to OpenCode's primary agent.
