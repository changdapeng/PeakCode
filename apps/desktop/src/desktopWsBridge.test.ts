...
// Purpose: Verifies desktop WebSocket URL resolution prefers Peak Code env names with legacy fallback.
...
describe("desktopWsBridge", () => {
  ...
  it("prefers PEAKCODE_DESKTOP_WS_URL over legacy T3CODE_DESKTOP_WS_URL", () => {
    expect(
